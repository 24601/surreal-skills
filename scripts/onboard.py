...
CAPABILITIES_MANIFEST: dict = {
    ...
    "rules": [
        ...
        {"file": "sdks.md", "topic": "SDK patterns for JS, Python, Go, Rust, Java, Kotlin, .NET, Swift, Ruby"},
        {"file": "deployment.md", "topic": "Docker, Kubernetes, cloud, distributed deployment, setup-surreal CLI"},
        {"file": "surrealism.md", "topic": "WASM extension development"},
        {"file": "surrealml.md", "topic": "ML model upload (.surml) and in-database inference"},
        {"file": "surrealmcp.md", "topic": "Model Context Protocol server for AI agent hosts"},
        {"file": "editor-tooling.md", "topic": "LSP, tree-sitter, VS Code / JetBrains / Neovim / Zed extensions"},
        {"file": "langchain.md", "topic": "LangChain Python + JS integration: vector store, retrievers, chat history"},
    ...
    "decision_trees": {
        "new_project": "Run doctor -> Optionally bootstrap with setup-surreal (deployment.md) -> Design schema (data-modeling.md) -> Choose deployment (deployment.md) -> Configure security (security.md)",
        ...
        "ml_inference": "Train model -> Wrap with surrealml.SurMlFile (surrealml.md) -> Upload via DEFINE MODEL -> Call ml::name<version>(...) from SurrealQL -> Roll out new versions with SurrealKit",
        "agent_integration": "Install surrealmcp -> Register in MCP host config (surrealmcp.md) -> Pair with scoped DEFINE USER -> Use schema.* tools to ground agent generation",
        "editor_setup": "cargo install surrealql-language-server -> Install editor extension (editor-tooling.md) -> Configure surrealql.toml for live schema completion -> Wire CI lint",
